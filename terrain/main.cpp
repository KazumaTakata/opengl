...
int main()
{
    ...
    float points[] = {
        ...
        0.0f, 0.0f, 0.0f, 0.5f, 0.0f, 0.5f, 0.0f, 0.0f, 0.5f, //
    };
    ...
    for (int i = 0; i < 10; i++)
    {
        for (int i2 = 0; i2 < 10; i2++)
        {
            ...
            for (int j = 0; j < 18; j++)
            {
                if (j % 3 == 0)
                {
                    vertices.push_back(points[j] + 0.5f * i);
                }
                else if (j % 3 == 2)
                {
                    vertices.push_back(points[j] + 0.5f * i2);
                }
                else
                {
    ...
    string dir = "/Users/kazumatakata/c++/opengl/terrain/";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //     glm::vec3(camX, 0.0, camZ), // Camera is at (4,3,3), in World Space
